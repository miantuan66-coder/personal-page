...
const translations = {
  ja: {
    ...
    lifeMediaTitle: "写真・動画で残す記録",
    lifeMediaLead: "生活や学習の様子を、画像や短い動画と一緒に整理していきます。",
  ...
  zh: {
    ...
    mediaVideoLabel: "视频",
    mediaResultLabel: "成果",
    lifeMediaTitle: "用图片和视频留下记录",
    lifeMediaLead: "这里会把生活和学习的过程，用图片或短视频一起整理出来。",
  ...
  en: {
    ...
    mediaVideoLabel: "Video",
    mediaResultLabel: "Result",
    lifeMediaTitle: "Photo and Video Notes",
    lifeMediaLead: "I will organize life and learning moments with images or short videos.",

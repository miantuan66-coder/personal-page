...
const translations = {
  ja: {
    ...
    aiBlock2Copy: "運動、食事、生活リズムを整えるためにAIを使い、続けやすい形にしています。",
    aiBlock3Title: "作った成果",
  ...
  zh: {
    ...
    aiBlock2Title: "用于生活",
    aiBlock2Copy: "我用 AI 帮助自己整理运动、饮食和作息，让生活更容易持续。",
    aiBlock3Title: "做出的成果",
  ...
  en: {
    ...
    aiBlock2Copy: "I use AI to support exercise, meals, and daily rhythm so my routine becomes easier to continue.",
